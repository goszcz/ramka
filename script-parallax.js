...
function renderWidget(data) {
    ...
    const widgetHtml = `
        <div class="widget-container">
            <div class="widget-header" style="background-image: url('${headerBg}');"></div>
    ...
    function updateParallax() {
        requestAnimationFrame(() => {
            ...
            images.forEach(img => {
                ...
                // Odległość od środka ekranu
                const offset = elementCenter - viewportHalf;

                // Mnożnik - ujemny oznacza że obraz podąża z inna predkoscia
